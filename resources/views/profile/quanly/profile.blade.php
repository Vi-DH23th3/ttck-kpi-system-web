<div class="sticky-top" style="top: 100px; z-index: 10;">
    ...
    <div class="card-footer bg-transparent border-top-0 p-4 pt-0">
        <a href="{{ route('manager.donvi.show', Auth::user()->don_vi_id) }}" class="btn btn-outline-primary btn-sm w-100 rounded-pill transition-all">
            <i class="bi bi-eye me-1"></i> Xem chi tiết đơn vị
        </a>  
    </div>
</div>
@push('script')
